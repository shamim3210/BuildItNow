...
- [ ] `npm run seed` populates 30,000+ books across 36 categories, including CSE, BBA, EEE, Civil, Mechanical, Textile, and Bangla departments
...
- [ ] Register selecting "Librarian" role → Admin tab appears in navigation
